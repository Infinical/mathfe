...
export const environment = {
  ...
  webAuth: {
    ...
    redirectUri: "https://math.allgifted.com/home", //http://math.all-gifted.com/home
    theme: {
  ...
  payPal: {
    ...
    productionKey:
      "AcWwalMgPfGKd-sT_fHGPOf6hAnLc_i8LfhuWlGSl29pd4tR3FWi66FGJt_dI6LPcPvby0yQ1JP4UTK0",
    sandboxKey:
